...
# Use default static storage for development, whitenoise for production
if DEBUG:
...
# CLOUDINARY_STORAGE = {
#     'CLOUD_NAME': config('CLOUD_NAME', default='dummy_cloud_name'),
#     'API_KEY': config('API_KEY', default='dummy_api_key'),
#     'API_SECRET': config('API_SECRET', default='dummy_api_secret'),
# }
...
RAZORPAY_SECRET_KEY = config('RAZORPAY_SECRET_KEY', default='dummy_razorpay_secret')
